...
cc._RF.push(module, '5d09cKAcypLB7FSChbAPtHs', 'GameScene', __filename);
// Script/GameScene.js
...
cc.Class({
    ...
    onbtnCLick: function onbtnCLick(event, cusutomData) {
        switch (cusutomData) {
            case "btnPack":
                this.onbtnpackCard();
                break;
    ...
    //重新洗牌并且发牌
    onbtnpackCard: function onbtnpackCard() {
        this.countTime();
        this.scheduleOnce(function () {
            this.btnNextRound.node.active = true;
        }, 3);
        this.dropCards();
    },
    ...
    /*按钮响应函数*/
    onbtnsideShow: function onbtnsideShow() {
        this.btnSideShow.node.active = false;
        this.btnPack.node.active = false;
    ...
    onbtnSeeCards: function onbtnSeeCards() {
        this.cardValue();
        this.sideShow();
        for (var i = 0; i < 6; i++) {
            this.cardBG[i].node.active = true;
    ...
    onbtnNextRound: function onbtnNextRound() {
    ...
    hideactive: function hideactive(isShow) {
    ...
    /*检测手中牌型*/
    checkHandType: function checkHandType(CardHandValue, CardHandType) {
    ...
    /*检测豹子*/
    checkbaozi: function checkbaozi(CardHandValue) {
    ...
    /*检测同花*/
    checktonghua: function checktonghua(CardHandType) {
    ...
    /*检测顺子*/
    checkshunzi: function checkshunzi(CardHandValue) {
    ...
    /*检测对子*/
    checkduizi: function checkduizi(CardHandValue) {
        var tempcount = 0;
    ...
    /*检测单张*/
    checkdanzhang: function checkdanzhang(CardHandValue) {
        var tempcount = 0;
    ...
    /*判断玩家是否为赢家*/
    jadgeIsOrNotWinner: function jadgeIsOrNotWinner() {
